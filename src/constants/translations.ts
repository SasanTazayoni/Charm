...
export const translations = {
  ...
  admin: {
    ...
    replacePhotoLabel:      createTranslation("Replace photo", "Zamijeni fotografiju"),
    replaceSuccess:         createTranslation("Photo replaced successfully.", "Fotografija je uspješno zamijenjena."),
    replaceError:           createTranslation("Replace failed. Please try again.", "Zamjena nije uspjela. Pokušajte ponovo."),
